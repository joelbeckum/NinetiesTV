...
namespace NinetiesTV
{
    class Program
    {
        ...
        **************************************************************************************************/
        ...
        {
            return shows
                .Where(s => s.StartYear > 1989 && s.EndYear < 2000)
                .ToList();
        }
        ...
        static Show FirstLongRunningTopRated(List<Show> shows)
        {
            return shows
                .OrderBy(s => s.Name)
                .FirstOrDefault(s => s.ImdbRating < 8.0 && s.EndYear - s.StartYear > 10);
        }
        ...
        **************************************************************************************************/
        ...
        static string GenresOfEightiesShows(List<Show> shows)
        {
            List<Show> eightiesShows = shows
                                        .Where(s => s.StartYear > 1979 && s.StartYear < 1990)
                                        .ToList();
